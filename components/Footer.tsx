...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    social: [
      ...
      { name: 'YouTube', href: 'https://www.youtube.com/@MarketingyTecnologiadePu-fc7xv/videos', icon: <YoutubeIcon className="w-5 h-5" /> },
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 text-primary-400 hover:gap-3 transition-all text-sm font-medium mb-3"
            >
              Schedule a call
